...
- **2026-08-11 — phone-OTP deferral UN-DEFERRED (v1 re-cut, gate B5 / slice R4 — approved in
  principle, open until its PR).** Guest booking arrives via **opaque, short-lived,
