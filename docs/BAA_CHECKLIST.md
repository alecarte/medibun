...
| SMS vendor — **Twilio** (B4 decided 2026-08-13; ADR-0005)                                             | Outbound texts to patient phone numbers                                                                                            | Gates R6 sends · weeks — **start the Twilio BAA now** (it also unblocks 10DLC below)                                |
| Email vendor — SendGrid under the Twilio BAA if terms allow, else **Mailgun** (B4 decided 2026-08-13) | Outbound email to patients                                                                                                         | Gates R6 sends · weeks; Postmark and Resend disqualified (no BAA)                                                   |
