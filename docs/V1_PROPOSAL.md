...
| Slice  | Status                                | Notes                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| ------ | ------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| R0     | Near-complete (2026-08-14)            | Export set delivered as local CSVs and assessed (RECOVERY_DESIGN review log, 2026-08-14): **dormant + unconverted-consult pools feasible; inquiry pool infeasible at Handal** (4D doesn't track inquiries) — R2 segmentation targets the two feasible pools, inquiry queries parked with their pool. CSV headers received 2026-08-14 — report-layout dumps, so the R1 adapter gains a normalization pre-pass (RECOVERY_DESIGN review log); the Revenue CSV carries a patient `Id`; full-range revenue re-pull done. Closure items: Conversion-report CSV header region, unfiltered patient re-pull. |
