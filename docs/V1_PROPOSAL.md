...
| Slice  | Status                                | Notes                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| ------ | ------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| R0     | Near-complete (2026-08-14)            | Export set delivered as local CSVs and assessed (RECOVERY_DESIGN review log, 2026-08-14): **dormant + unconverted-consult pools feasible; inquiry pool infeasible at Handal** (4D doesn't track inquiries) — R2 segmentation targets the two feasible pools, inquiry queries parked with their pool. Closure items: CSV header rows (mapping finalization), unfiltered patient re-pull, full-range revenue re-pull.                                                      |
