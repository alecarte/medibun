...
- PHI never leaks into: logs, error messages, analytics/telemetry, URLs or query params, push
  or SMS bodies, plaintext client storage, prompts to any non-BAA service, or any third party
